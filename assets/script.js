function updateScreen() {
  ...
  var imagestring = "url(http://api.usno.navy.mil/imagery/mercury.png?view=full&date=" + utcDate + "&time=" + utcTime + ")";
  ...
  breakable: if (!~document.getElementById("time").innerHTML.indexOf(time)){
    ...
    if(~document.getElementById("image").style.backgroundImage.indexOf("mercury")){
